...
local theme_path = "/home/oniichan/.config/awesome/themes/asuka/"

local theme = {}

theme.font = "Anime Ace v3 8"
theme.menu_height = 8

theme.bg_normal     = "#8B0000" -- dark red
theme.bg_focus      = "#E41B17" -- ruby
...
theme.border_normal = "#837E7C" -- granide
theme.border_focus  = "#E5E4E2" -- platinum
theme.border_marked = "#0C090A" -- night
...
theme.awesome_icon = theme_path.."icon.jpg"
